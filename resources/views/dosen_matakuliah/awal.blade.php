...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<a href="{{url('dosen_matakuliah/tambah')}}" class="btn btn-xs btn-primary pull-right"><i class="fa fa-plus">dosen_matakuliah</i></a>
	...
	<table class="table">
		...
		<body>
			...
			<tr>
				...
				<td>{{ $dosen_matakuliah->dosen->nim or 'NIM Kosong' }}</td>
